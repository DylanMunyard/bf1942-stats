...
public abstract class PaginatedRequest
{
    ...
    [Range(1, ApiConstants.Pagination.MaxPageSize, ErrorMessage = "Page size must be between 1 and 500")]
    ...
    public string SortOrder { get; set; } = ApiConstants.Sorting.AscendingOrder;
}
...
public class GetAllServersRequest : PaginatedRequest
{
    ...
    {
        get => _sortBy ?? ApiConstants.ServerSortFields.ServerName;
        set => _sortBy = value;
    }
...
public class SearchServersRequest
{
    ...
    [Range(1, ApiConstants.Pagination.SearchMaxPageSize, ErrorMessage = "Page size must be between 1 and 100")]
...
public class GetAllPlayersRequest : PaginatedRequest
{
    public override string SortBy
    {
        get => _sortBy ?? ApiConstants.PlayerSortFields.IsActive;
        set => _sortBy = value;
    }
    private string? _sortBy;
    ...
    {
        get => _sortOrder ?? ApiConstants.Sorting.DescendingOrder;
